...
generate_portfolio_multiple_options <- function(termsheet){
  ...
  write.csv(test,"data/OptionsPortfolio_dev1.csv", row.names = FALSE)
  #optionsDataFile2 <- "C:/Users/janni/Desktop/Projekt/BA_structured_products/Francis_Suff/data/OptionsPortfolio_dev1.csv"
  optionsDataFile2 <- "data/OptionsPortfolio_dev1.csv"

  RiskFactor_to_manipulate <- file2RiskFactors_df(fname = "data/RiskFactors_dev.csv",sep = ",")
  ...
  write.csv(RiskFactor_to_manipulate,file = "data/RiskFactors_devManipulated.csv" ,row.names = FALSE)
  ...
  riskFactorsDataFile1 <-"data/RiskFactors_devManipulated.csv"
